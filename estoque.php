...
<head>
<meta charset="UTF-8">
<title>Gestão de Estoque - Vault-Tech</title>
...
<tr>
  ...
  <td><?= htmlspecialchars($p['processador']) ?></td>
  <td><?= htmlspecialchars($p['ram']) ?></td>
  <td><?= htmlspecialchars($p['armazenamento']) ?></td>
  <td><?= htmlspecialchars($p['tamanho_tela']) ?></td>
  <td><?= htmlspecialchars($p['resolucao']) ?></td>
  <td><?= htmlspecialchars($p['sistema_ope']) ?></td>
